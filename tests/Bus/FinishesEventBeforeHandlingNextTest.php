...
namespace SimpleBus\Event\Tests;
...
class FinishesEventBeforeHandlingNextTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->eventBus = new \SimpleBus\Event\Bus\FinishesEventBeforeHandlingNext();
    ...
    {
        return $this->getMock('SimpleBus\Event\Bus\EventBus');
    }
    ...
    {
        return $this->getMock('SimpleBus\Event\Event');
    }
}
